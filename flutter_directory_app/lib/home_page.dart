...
class _HomePageState extends ConsumerState<HomePage> {
  ...
  Widget build(BuildContext context) {
    hello() async {
      ...
      print("SHARED PREFERENCE CALLED AT BUILD CONTEXT OF HOME PAGE $checkNum");
    }
    ...
    return WillPopScope(
      onWillPop: () async {
        ...
        print("PHONE NUMBER AT HOME PAGE ON WILL POP $showNum");
        // await sharedPref.setString(MyAppState.PHONENUM, value!);
